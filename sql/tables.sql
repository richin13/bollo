CREATE TABLE bollo_bakery (
  ...
  bakery_progress INT          NOT NULL DEFAULT 0,
...
CREATE TABLE bollo_logbook (
  ...
  logbook_date        TIMESTAMP(0) NOT NULL DEFAULT (NOW()),
  logbook_bakery      INT,
...
CREATE TABLE bollo_session (
  ...
  sess_lastlog  TIMESTAMP(0) NOT NULL DEFAULT (NOW()),
  sess_user     INT,
...
CREATE TABLE forgotten_pwds (
  ...
  fpwd_date  TIMESTAMP(0) NOT NULL DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'utc-6'),
  fpwd_user  INT,
